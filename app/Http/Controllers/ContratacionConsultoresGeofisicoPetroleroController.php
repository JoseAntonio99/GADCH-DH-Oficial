...
use App\Models\ContratacionConsultoresGeofisicoPetrolero;

class ContratacionConsultoresGeofisicoPetroleroController extends Controller
{
    ...
    {
        $documents = ContratacionConsultoresGeofisicoPetrolero::all();
        ...
        return view('cntrtcncnsltgrsgfscptrlr.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('cntrtcncnsltgrsgfscptrlr.create', compact('config'));
    }
    ...
    {
        $documents = new ContratacionConsultoresGeofisicoPetrolero();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Contratacion Consultores Geofisico Petrolero/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/cntrtcncnsltgrsgfscptrlr')->with('store', 'str');
    }
    ...
    {
        $document = ContratacionConsultoresGeofisicoPetrolero::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('cntrtcncnsltgrsgfscptrlr.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/cntrtcncnsltgrsgfscptrlr')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/cntrtcncnsltgrsgfscptrlr')->with('delete', 'dlt');
    }
}
