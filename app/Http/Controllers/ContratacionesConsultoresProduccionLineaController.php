...
use App\Models\ContratacionesConsultoresProduccionLinea;

class ContratacionesConsultoresProduccionLineaController extends Controller
{
    ...
    {
        $documents = ContratacionesConsultoresProduccionLinea::all();
        ...
        return view('cntrtcnscnsltrsprdcccln.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('cntrtcnscnsltrsprdcccln.create', compact('config'));
    }
    ...
    {
        $documents = new ContratacionesConsultoresProduccionLinea();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Contrataciones Consultores Produccion Linea/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/cntrtcnscnsltrsprdcccln')->with('store', 'str');
    }
    ...
    {
        $document = ContratacionesConsultoresProduccionLinea::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('cntrtcnscnsltrsprdcccln.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/cntrtcnscnsltrsprdcccln')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/cntrtcnscnsltrsprdcccln')->with('delete', 'dlt');
    }
}
