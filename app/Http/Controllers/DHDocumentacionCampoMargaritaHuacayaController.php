...
use App\Models\DHDocumentacionCampoMargaritaHuacaya;

class DHDocumentacionCampoMargaritaHuacayaController extends Controller
{
    ...
    {
        $documents = DHDocumentacionCampoMargaritaHuacaya::all();
        ...
        return view('dhdcmntcncmpmrgrthcy.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('dhdcmntcncmpmrgrthcy.create', compact('config'));
    }
    ...
    {
        $documents = new DHDocumentacionCampoMargaritaHuacaya();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/DH Documentacion Campo Margarita Huacaya/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/dhdcmntcncmpmrgrthcy')->with('store', 'str');
    }
    ...
    {
        $document = DHDocumentacionCampoMargaritaHuacaya::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('dhdcmntcncmpmrgrthcy.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/dhdcmntcncmpmrgrthcy')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/dhdcmntcncmpmrgrthcy')->with('delete', 'dlt');
    }
}
