...
use App\Models\DHEAFDCampoMargaritaHuacaya;

class DHEAFDCampoMargaritaHuacayaController extends Controller
{
    ...
    {
        $documents = DHEAFDCampoMargaritaHuacaya::all();
        ...
        return view('dheafdcmpmrgrthcy.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('dheafdcmpmrgrthcy.create', compact('config'));
    }
    ...
    {
        $documents = new DHEAFDCampoMargaritaHuacaya();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/DH EAFD Campo Margarita Huacaya/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/dheafdcmpmrgrthcy')->with('store', 'str');
    }
    ...
    {
        $document = DHEAFDCampoMargaritaHuacaya::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('dheafdcmpmrgrthcy.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/dheafdcmpmrgrthcy')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/dheafdcmpmrgrthcy')->with('delete', 'dlt');
    }
}
