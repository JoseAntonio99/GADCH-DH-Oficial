...
use App\Models\DirectorioYPFBNotasInformes;

class DirectorioYPFBNotasInformesController extends Controller
{
    ...
    {
        $documents = DirectorioYPFBNotasInformes::all();
        ...
        return view('dctrypfbntsnfrms.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('dctrypfbntsnfrms.create', compact('config'));
    }
    ...
    {
        $documents = new DirectorioYPFBNotasInformes();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Directorio YPFB Notas Informes/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/dctrypfbntsnfrms')->with('store', 'str');
    }
    ...
    {
        $document = DirectorioYPFBNotasInformes::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('dctrypfbntsnfrms.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/dctrypfbntsnfrms')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/dctrypfbntsnfrms')->with('delete', 'dlt');
    }
}
