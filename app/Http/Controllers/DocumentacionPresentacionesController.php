...
use App\Models\DocumentacionPresentaciones;

class DocumentacionPresentacionesController extends Controller
{
    ...
    {
        $documents = DocumentacionPresentaciones::all();
        ...
        return view('dcmntcnprsntcns.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('dcmntcnprsntcns.create', compact('config'));
    }
    ...
    {
        $documents = new DocumentacionPresentaciones();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Documentacion Presentaciones/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/dcmntcnprsntcns')->with('store', 'str');
    }
    ...
    {
        $document = DocumentacionPresentaciones::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('dcmntcnprsntcns.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/dcmntcnprsntcns')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/dcmntcnprsntcns')->with('delete', 'dlt');
    }
}
