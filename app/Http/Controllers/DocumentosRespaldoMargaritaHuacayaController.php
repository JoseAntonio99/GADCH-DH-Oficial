...
use App\Models\DocumentosRespaldoMargaritaHuacaya;

class DocumentosRespaldoMargaritaHuacayaController extends Controller
{
    ...
    {
        $documents = DocumentosRespaldoMargaritaHuacaya::all();
        ...
        return view('dcmntsrspldmrgrthcy.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('dcmntsrspldmrgrthcy.create', compact('config'));
    }
    ...
    {
        $documents = new DocumentosRespaldoMargaritaHuacaya();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Documentos Respaldo Margarita Huacaya/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/dcmntsrspldmrgrthcy')->with('store', 'str');
    }
    ...
    {
        $document = DocumentosRespaldoMargaritaHuacaya::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('dcmntsrspldmrgrthcy.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/dcmntsrspldmrgrthcy')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/dcmntsrspldmrgrthcy')->with('delete', 'dlt');
    }
}
