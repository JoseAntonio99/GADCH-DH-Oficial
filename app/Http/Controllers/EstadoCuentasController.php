...
class EstadoCuentasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('stdcnts.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('stdcnts.create', compact('config'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Estado Cuentas/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/stdcnts')->with('store', 'str');
    }
    ...
    {
        $document = EstadoCuentas::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('stdcnts.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/stdcnts')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/stdcnts')->with('delete', 'dlt');
    }
}
