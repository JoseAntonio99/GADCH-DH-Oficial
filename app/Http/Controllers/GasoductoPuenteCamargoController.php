...
use App\Models\GasoductoPuenteCamargo;

class GasoductoPuenteCamargoController extends Controller
{
    ...
    {
        $documents = GasoductoPuenteCamargo::all();
        ...
        return view('gsdctpntcmrg.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('gsdctpntcmrg.create', compact('config'));
    }
    ...
    {
        $documents = new GasoductoPuenteCamargo();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Gasoducto Puente Camargo/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/gsdctpntcmrg')->with('store', 'str');
    }
    ...
    {
        $document = GasoductoPuenteCamargo::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('gsdctpntcmrg.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/gsdctpntcmrg')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/gsdctpntcmrg')->with('delete', 'dlt');
    }
}
