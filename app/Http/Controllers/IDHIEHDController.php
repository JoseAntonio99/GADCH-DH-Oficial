...
use App\Models\IDHIEHD;

class IDHIEHDController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('idhiehd.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('idhiehd.create', compact('config'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/IDH IEHD/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/idhiehd')->with('store', 'str');
    }
    ...
    {
        $document = IDHIEHD::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('idhiehd.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/idhiehd')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/idhiehd')->with('delete', 'dlt');
    }
}
