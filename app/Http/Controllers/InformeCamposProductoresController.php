...
use App\Models\InformeCamposProductores;

class InformeCamposProductoresController extends Controller
{
    ...
    {
        $documents = InformeCamposProductores::all();
        ...
        return view('nfrmcmpsprdctrs.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('nfrmcmpsprdctrs.create', compact('config'));
    }
    ...
    {
        $documents = new InformeCamposProductores();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Informe Campos Productores/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/nfrmcmpsprdctrs')->with('store', 'str');
    }
    ...
    {
        $document = InformeCamposProductores::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('nfrmcmpsprdctrs.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/nfrmcmpsprdctrs')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/nfrmcmpsprdctrs')->with('delete', 'dlt');
    }
}
