...
use App\Models\LeyesSectorHidrocarburiferoEnergia;

class LeyesSectorHidrocarburiferoEnergiaController extends Controller
{
    ...
    {
        $documents = LeyesSectorHidrocarburiferoEnergia::all();
        ...
        return view('lyssctrhdrcrbrfrrg.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('lyssctrhdrcrbrfrrg.create', compact('config'));
    }
    ...
    {
        $documents = new LeyesSectorHidrocarburiferoEnergia();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Leyes Sector Hidrocarburifero Energia/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/lyssctrhdrcrbrfrrg')->with('store', 'str');
    }
    ...
    {
        $document = LeyesSectorHidrocarburiferoEnergia::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('lyssctrhdrcrbrfrrg.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/lyssctrhdrcrbrfrrg')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/lyssctrhdrcrbrfrrg')->with('delete', 'dlt');
    }
}
