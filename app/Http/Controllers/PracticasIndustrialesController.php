...
use App\Models\PracticasIndustriales;

class PracticasIndustrialesController extends Controller
{
    ...
    {
        $documents = PracticasIndustriales::all();
        ...
        return view('prctcsndstrls.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('prctcsndstrls.create', compact('config'));
    }
    ...
    {
        $documents = new PracticasIndustriales();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Practicas Industriales/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/prctcsndstrls')->with('store', 'str');
    }
    ...
    {
        $document = PracticasIndustriales::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('prctcsndstrls.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/prctcsndstrls')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/prctcsndstrls')->with('delete', 'dlt');
    }
}
