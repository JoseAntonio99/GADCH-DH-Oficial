...
class RecibidasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('rcbsd.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('rcbsd.create', compact('config'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Recibidas/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/rcbsd')->with('store', 'str');
    }
    ...
    {
        $document = Recibidas::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('rcbsd.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/rcbsd')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/rcbsd')->with('delete', 'dlt');
    }
}
