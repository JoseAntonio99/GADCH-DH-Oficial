...
use App\Models\RecibidasExternas;

class RecibidasExternasController extends Controller
{
    ...
    {
        $documents = RecibidasExternas::all();
        ...
        return view('rcbdsxtrns.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('rcbdsxtrns.create', compact('config'));
    }
    ...
    {
        $documents = new RecibidasExternas();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Recibidas Externas/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/rcbdsxtrns')->with('store', 'str');
    }
    ...
    {
        $document = RecibidasExternas::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('rcbdsxtrns.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/rcbdsxtrns')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/rcbdsxtrns')->with('delete', 'dlt');
    }
}
