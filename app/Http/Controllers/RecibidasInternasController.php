...
use App\Models\RecibidasInternas;

class RecibidasInternasController extends Controller
{
    ...
    {
        $documents = RecibidasInternas::all();
        ...
        return view('rcbdsntrns.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('rcbdsntrns.create', compact('config'));
    }
    ...
    {
        $documents = new RecibidasInternas();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Recibidas Internas/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/rcbdsntrns')->with('store', 'str');
    }
    ...
    {
        $document = RecibidasInternas::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('rcbdsntrns.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/rcbdsntrns')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/rcbdsntrns')->with('delete', 'dlt');
    }
}
