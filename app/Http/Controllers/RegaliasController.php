...
class RegaliasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('rgls.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('rgls.create', compact('config'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Regalias/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/rgls')->with('store', 'str');
    }
    ...
    {
        $document = Regalias::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('rgls.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/rgls')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/rgls')->with('delete', 'dlt');
    }
}
