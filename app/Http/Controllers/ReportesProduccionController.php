...
use App\Models\ReportesProduccion;
...
class ReportesProduccionController extends Controller
{
    ...
    {
        $documents = ReportesProduccion::all();
        ...
        return view('rprtsprdccn.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('rprtsprdccn.create', compact('config'));
    }
    ...
    {
        $documents = new ReportesProduccion();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Reportes Produccion/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/rprtsprdccn')->with('store', 'str');
    }
    ...
    {
        $document = ReportesProduccion::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('rprtsprdccn.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/rprtsprdccn')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/rprtsprdccn')->with('delete', 'dlt');
    }
}
