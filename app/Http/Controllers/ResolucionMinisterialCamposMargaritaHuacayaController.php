...
use App\Models\ResolucionMinisterialCamposMargaritaHuacaya;

class ResolucionMinisterialCamposMargaritaHuacayaController extends Controller
{
    ...
    {
        $documents = ResolucionMinisterialCamposMargaritaHuacaya::all();
        ...
        return view('rslcnmnstrlcmpsmrgrthcy.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('rslcnmnstrlcmpsmrgrthcy.create', compact('config'));
    }
    ...
    {
        $documents = new ResolucionMinisterialCamposMargaritaHuacaya();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Resolucion Ministerial Campos Margarita Huacaya/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/rslcnmnstrlcmpsmrgrthcy')->with('store', 'str');
    }
    ...
    {
        $document = ResolucionMinisterialCamposMargaritaHuacaya::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('rslcnmnstrlcmpsmrgrthcy.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/rslcnmnstrlcmpsmrgrthcy')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/rslcnmnstrlcmpsmrgrthcy')->with('delete', 'dlt');
    }
}
