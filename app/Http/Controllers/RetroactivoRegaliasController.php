...
use App\Models\RetroactivoRegalias;

class RetroactivoRegaliasController extends Controller
{
    ...
    {
        $documents = RetroactivoRegalias::all();
        ...
        return view('rtrctvrgls.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('rtrctvrgls.create', compact('config'));
    }
    ...
    {
        $documents = new RetroactivoRegalias();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/Retroactivo Regalias/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/rtrctvrgls')->with('store', 'str');
    }
    ...
    {
        $document = RetroactivoRegalias::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('rtrctvrgls.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/rtrctvrgls')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/rtrctvrgls')->with('delete', 'dlt');
    }
}
