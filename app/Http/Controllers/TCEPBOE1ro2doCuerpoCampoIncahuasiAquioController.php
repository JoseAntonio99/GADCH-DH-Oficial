...
use App\Models\TCEPBOE1ro2doCuerpoCampoIncahuasiAquio;

class TCEPBOE1ro2doCuerpoCampoIncahuasiAquioController extends Controller
{
    ...
    {
        $documents = TCEPBOE1ro2doCuerpoCampoIncahuasiAquio::all();
        ...
        return view('tcepboe1ro2docrpcmpnchsq.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('tcepboe1ro2docrpcmpnchsq.create', compact('config'));
    }
    ...
    {
        $documents = new TCEPBOE1ro2doCuerpoCampoIncahuasiAquio();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/TCEPB OE 1ro 2do Cuerpo Campo Incahuasi Aquio/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/tcepboe1ro2docrpcmpnchsq')->with('store', 'str');
    }
    ...
    {
        $document = TCEPBOE1ro2doCuerpoCampoIncahuasiAquio::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('tcepboe1ro2docrpcmpnchsq.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/tcepboe1ro2docrpcmpnchsq')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/tcepboe1ro2docrpcmpnchsq')->with('delete', 'dlt');
    }
}
