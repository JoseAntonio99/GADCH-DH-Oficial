...
use App\Models\TCEPBOE3ro4toCuerpoCampoIncahuasiAquio;

class TCEPBOE3ro4toCuerpoCampoIncahuasiAquioController extends Controller
{
    ...
    {
        $documents = TCEPBOE3ro4toCuerpoCampoIncahuasiAquio::all();
        ...
        return view('tcepboe3ro4tocrpcmpnchsq.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('tcepboe3ro4tocrpcmpnchsq.create', compact('config'));
    }
    ...
    {
        $documents = new TCEPBOE3ro4toCuerpoCampoIncahuasiAquio();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/TCEPB OE 3ro 4to Cuerpo Campo Incahuasi Aquio/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/tcepboe3ro4tocrpcmpnchsq')->with('store', 'str');
    }
    ...
    {
        $document = TCEPBOE3ro4toCuerpoCampoIncahuasiAquio::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('tcepboe3ro4tocrpcmpnchsq.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/tcepboe3ro4tocrpcmpnchsq')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/tcepboe3ro4tocrpcmpnchsq')->with('delete', 'dlt');
    }
}
