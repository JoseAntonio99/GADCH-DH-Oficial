...
use App\Models\TCEPBOE5to6toCuerpoCampoIncahuasiAquio;

class TCEPBOE5to6toCuerpoCampoIncahuasiAquioController extends Controller
{
    ...
    {
        $documents = TCEPBOE5to6toCuerpoCampoIncahuasiAquio::all();
        ...
        return view('tcepboe5to6tocrpcmpnchsq.index', compact('documents', 'config', 'heads' ));
    }
    ...
    public function create()
    {
        ...
        return view('tcepboe5to6tocrpcmpnchsq.create', compact('config'));
    }
    ...
    {
        $documents = new TCEPBOE5to6toCuerpoCampoIncahuasiAquio();
        ...
        if ($request->hasFile('pdf')) {
            ...
            $file->move(public_path() . '/TCEPB OE 5to 6to Cuerpo Campo Incahuasi Aquio/', $file->getClientOriginalName());
            $documents->pdf = $file->getClientOriginalName();
        }

        $documents->save();

        return redirect('/tcepboe5to6tocrpcmpnchsq')->with('store', 'str');
    }
    ...
    {
        $document = TCEPBOE5to6toCuerpoCampoIncahuasiAquio::find($id);

        $config = ['format' => 'YYYY/MM/DD'];

        return view('tcepboe5to6tocrpcmpnchsq.edit', compact('document', 'config'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/tcepboe5to6tocrpcmpnchsq')->with('edit', 'dt');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/tcepboe5to6tocrpcmpnchsq')->with('delete', 'dlt');
    }
}
