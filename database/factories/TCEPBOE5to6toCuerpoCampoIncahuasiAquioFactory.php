...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\TCEPBOE5to6toCuerpoCampoIncahuasiAquio>
 */
class TCEPBOE5to6toCuerpoCampoIncahuasiAquioFactory extends Factory
{
    /**
