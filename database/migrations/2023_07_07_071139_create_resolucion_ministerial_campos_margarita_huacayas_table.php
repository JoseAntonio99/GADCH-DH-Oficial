...
return new class extends Migration
{
    ...
    {
        Schema::create('resolucion_ministerial_campos_margarita_huacayas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('resolucion_ministerial_campos_margarita_huacayas');
    }
};
