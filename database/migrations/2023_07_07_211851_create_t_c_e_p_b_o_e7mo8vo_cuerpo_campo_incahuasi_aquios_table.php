...
return new class extends Migration
{
    ...
    {
        Schema::create('t_c_e_p_b_o_e7mo8vo_cuerpo_campo_incahuasi_aquios', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('t_c_e_p_b_o_e7mo8vo_cuerpo_campo_incahuasi_aquios');
    }
};
