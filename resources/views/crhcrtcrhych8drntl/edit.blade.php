...
@section('content_header')
    <div class="row g-3">
        <div class="col-sm-6">
            <form action="/crhcrtcrhych8drntl/{{ $document->id }}" method="POST" enctype="multipart/form-data" class="form-edit">
                <a href="/crhcrtcrhych8drntl">
        ...
        <div class="col-sm-6">
            <h1>Acero Huacareta Carahuaychu 8D Oriental Edit Files</h1>
        </div>
    </div>
@stop
