...
@section('content_header')
    <div class="row g-3">
        <div class="col-sm-6">
            <form action="/dcmntcnprsntcns/{{ $document->id }}" method="POST" enctype="multipart/form-data" class="form-edit">
                <a href="/dcmntcnprsntcns">
        ...
        <div class="col-sm-6">
            <h1>Documentacion Presentaciones Edit Files</h1>
        </div>
    </div>
@stop
