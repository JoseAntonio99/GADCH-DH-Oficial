...
@section('content_header')
    <div class="row g-3">
        <div class="col-sm-6">
            <form action="/gsdctpntcmrg/{{ $document->id }}" method="POST" enctype="multipart/form-data" class="form-edit">
                <a href="/gsdctpntcmrg">
        ...
        <div class="col-sm-6">
            <h1>Gasoducto Puente Camargo Edit Files</h1>
        </div>
    </div>
@stop
