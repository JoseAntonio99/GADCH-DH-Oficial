...
@section('content_header')
    <div class="row g-3">
        <div class="col-sm-6">
            <form action="/nfrmcmpsprdctrs/{{ $document->id }}" method="POST" enctype="multipart/form-data" class="form-edit">
                <a href="/nfrmcmpsprdctrs">
        ...
        <div class="col-sm-6">
            <h1>Informe Campos Productores Edit Files</h1>
        </div>
    </div>
@stop
