...
@section('content_header')
    <div class="row g-3">
        <div class="col-sm-6">
            <form action="/prctcsndstrls/{{ $document->id }}" method="POST" enctype="multipart/form-data" class="form-edit">
                <a href="/prctcsndstrls">
        ...
        <div class="col-sm-6">
            <h1>Practicas Industriales Edit Files</h1>
        </div>
    </div>
@stop
