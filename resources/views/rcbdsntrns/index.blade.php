            ...
            @foreach($documents as $document)
                <tr>
                    ...
                    <td>{{ $document->observation }}</td>
                        <td>
                            <a href="Recibidas Internas/{{ $document->pdf }}" target="blank_">
                                <x-adminlte-button label="PDF" theme="success" icon="fas fa-file-pdf"/>
                            </a>
                        </td>
                    <td>
                        <form action="{{ route('rcbdsntrns.destroy', $document->id) }}" method="POST" class="form-delete">
                            <a href="/rcbdsntrns/{{ $document->id}}/edit">
