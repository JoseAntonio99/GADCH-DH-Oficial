...
@section('content_header')
    <div class="row g-3">
        <div class="col-sm-6">
            <form action="/rprtsprdccn/{{ $document->id }}" method="POST" enctype="multipart/form-data" class="form-edit">
                <a href="/rprtsprdccn">
        ...
        <div class="col-sm-6">
            <h1>Reportes Produccion Edit Files</h1>
        </div>
    </div>
@stop
