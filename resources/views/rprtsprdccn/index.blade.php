            ...
            @foreach($documents as $document)
                <tr>
                    ...
                    <td>{{ $document->observation }}</td>
                        <td>
                            <a href="Reportes Produccion/{{ $document->pdf }}" target="blank_">
                                <x-adminlte-button label="PDF" theme="success" icon="fas fa-file-pdf"/>
                            </a>
                        </td>
                    <td>
                        <form action="{{ route('rprtsprdccn.destroy', $document->id) }}" method="POST" class="form-delete">
                            <a href="/rprtsprdccn/{{ $document->id}}/edit">
