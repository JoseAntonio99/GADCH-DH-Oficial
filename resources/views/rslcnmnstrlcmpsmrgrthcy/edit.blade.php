...
@section('content_header')
    <div class="row g-3">
        <div class="col-sm-6">
            <form action="/rslcnmnstrlcmpsmrgrthcy/{{ $document->id }}" method="POST" enctype="multipart/form-data" class="form-edit">
                <a href="/rslcnmnstrlcmpsmrgrthcy">
        ...
        <div class="col-sm-6">
            <h1>Resolucion Ministerial Campos Margarita Huacaya Edit Files</h1>
        </div>
    </div>
@stop
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <x-adminlte-select2 id="folder_name_and_year" name="folder_name_and_year" label="Folder Name and Year" rows=2 data-placeholder="Folder Name and Year" label-class="text-dark" value="{{ $document->folder_name_and_year}}" required>
                            ...
                            <option>Res.Min.Cmpo.Mga.Huac.</option>
                        </x-adminlte-select2>
                    </div>
                    <div class="col-sm-6">
