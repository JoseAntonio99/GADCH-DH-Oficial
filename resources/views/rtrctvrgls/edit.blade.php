...
@section('content_header')
    <div class="row g-3">
        <div class="col-sm-6">
            <form action="/rtrctvrgls/{{ $document->id }}" method="POST" enctype="multipart/form-data" class="form-edit">
                <a href="/rtrctvrgls">
        ...
        <div class="col-sm-6">
            <h1>Retroactivo Regalias Edit Files</h1>
        </div>
    </div>
@stop
