            ...
            @foreach($documents as $document)
                <tr>
                    ...
                    <td>{{ $document->observation }}</td>
                        <td>
                            <a href="Estado Cuentas/{{ $document->pdf }}" target="blank_">
                                <x-adminlte-button label="PDF" theme="success" icon="fas fa-file-pdf"/>
                            </a>
                        </td>
                    <td>
                        <form action="{{ route('stdcnts.destroy', $document->id) }}" method="POST" class="form-delete">
                            <a href="/stdcnts/{{ $document->id}}/edit">
