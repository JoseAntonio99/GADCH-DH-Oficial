...
@section('content_header')
    <div class="row g-3">
        <div class="col-sm-6">
            <form action="/tcepboe1ro2docrpcmpnchsq/{{ $document->id }}" method="POST" enctype="multipart/form-data" class="form-edit">
                <a href="/tcepboe1ro2docrpcmpnchsq">
        ...
        <div class="col-sm-6">
            <h1>TCEPB OE 1ro 2do Cuerpo Campo Incahuasi Aquio Edit Files</h1>
        </div>
    </div>
@stop
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <x-adminlte-select2 id="folder_name_and_year" name="folder_name_and_year" label="Folder Name and Year" rows=2 data-placeholder="Folder Name and Year" label-class="text-dark" value="{{ $document->folder_name_and_year}}" required>
                            ...
                            <option>1ro.2do.Crpo.Cmpo.I.A.</option>
                        </x-adminlte-select2>
                    </div>
                    <div class="col-sm-6">
